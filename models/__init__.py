...
from .forms import RegisterForm, LoginForm, LibroForm, ModificaLibroForm

# rendo pubblico tutto quello importato
# in modo da usarlo comodamente importando la cartella
__all__ = ["Libro", "Utente", "Prestito", "db", "RegisterForm", "LoginForm", "LibroForm", "ModificaLibroForm"]